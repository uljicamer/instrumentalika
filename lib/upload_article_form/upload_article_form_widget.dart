...
import 'upload_article_form_model.dart';
export 'upload_article_form_model.dart';

class UploadArticleFormWidget extends StatefulWidget {
  const UploadArticleFormWidget({Key? key}) : super(key: key);

  @override
  _UploadArticleFormWidgetState createState() =>
      _UploadArticleFormWidgetState();
}

class _UploadArticleFormWidgetState extends State<UploadArticleFormWidget> {
  late UploadArticleFormModel _model;
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 8.0, 0.0, 0.0),
                                          child: Text(
                                            'Postavite fotografiju na kojoj je vas artikal jasno vidljiv',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyText2
                                                .override(
                                                  fontFamily: 'Outfit',
