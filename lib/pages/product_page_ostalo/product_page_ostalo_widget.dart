...
import 'product_page_ostalo_model.dart';
export 'product_page_ostalo_model.dart';

class ProductPageOstaloWidget extends StatefulWidget {
  const ProductPageOstaloWidget({
    Key? key,
    this.kategorijaOstalo,
  }) : super(key: key);

  final DocumentReference? kategorijaOstalo;

  @override
  _ProductPageOstaloWidgetState createState() =>
      _ProductPageOstaloWidgetState();
}

class _ProductPageOstaloWidgetState extends State<ProductPageOstaloWidget> {
  late ProductPageOstaloModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductPageOstaloModel());
